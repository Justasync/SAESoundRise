  ...
  js: function () {
    ...
    tarteaucitron.fallback(["artetv_player"], function (x) {
      ...
      video_frame =
        ...
        '" style="' +
        styleAttr +
        'transition-duration: 0; transition-property: no; margin: 0 auto; position: relative; display: block; background-color: #000000;" src="https://www.arte.tv/player/v5//?json_url=' +
        video_json +
        '" ' +
